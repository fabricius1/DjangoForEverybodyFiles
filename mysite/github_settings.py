...
SOCIAL_AUTH_GITHUB_KEY = config_parser['LOCAL']['GITHUB_KEY']
SOCIAL_AUTH_GITHUB_SECRET = config_parser['LOCAL']['GITHUB_SECRET']

# SOCIAL_AUTH_GITHUB_KEY = config_parser['PYTHONANYWHERE']['GITHUB_KEY']
# SOCIAL_AUTH_GITHUB_SECRET = config_parser['PYTHONANYWHERE']['GITHUB_SECRET']
